...
with open("question5.csv", mode='r', encoding='utf-8') as g:
...
def question(qstn):
    for qstns in qstn:
        print(f"{qstns['QUESTIONS']} | {qstns['Réponse 1']} | {qstns['Réponse 2']} | {qstns['Réponse 3']}")
        print(f"{qstns['Courage']} | {qstns['Intelligence']} | {qstns['Ambition']} | {qstns['Good']}")
